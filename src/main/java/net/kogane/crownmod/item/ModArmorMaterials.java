...
public enum ModArmorMaterials implements ArmorMaterial {
    GOLD_CROWN("gold_crown", 37, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 9, SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> Ingredient.of(Items.GOLD_BLOCK)),

    COPPER_ARMOR("copper", 15, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 1);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 3);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 5);
    ...
    public String getName() {
        return CrownMod.MOD_ID + ":" + this.name;
    }
